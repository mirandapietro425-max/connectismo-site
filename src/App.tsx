...
type LibrasSignal = { slug: string; label: string; description: string };
const librasSignals: LibrasSignal[] = [
  { slug: "autismo", label: "Autismo", description: "Um ponto de partida para falar sobre o espectro sem reduzir a pessoa ao diagnóstico." },
  { slug: "acessibilidade", label: "Acessibilidade", description: "Mudanças no ambiente e na comunicação que tornam a participação possível." },
  { slug: "comunicacao", label: "Comunicação", description: "Diferentes maneiras de expressar, compreender e trocar informação." },
  { slug: "inclusao", label: "Inclusão", description: "Pertencimento com acesso, voz, escolhas e participação real." },
  { slug: "apoio", label: "Apoio", description: "Suporte individualizado, combinado com a pessoa e ajustado ao contexto." },
  { slug: "participacao", label: "Participação", description: "Mais de um caminho para estar presente, contribuir e fazer escolhas." },
  { slug: "educacao", label: "Educação", description: "Aprendizagem com diferentes formas de demonstrar o que se sabe." },
  { slug: "rotina", label: "Rotina", description: "Previsibilidade, combinados e avisos que ajudam nas transições." },
  { slug: "sensorial", label: "Sensorialidade", description: "Atenção a sons, luzes, cheiros, texturas e movimento." },
  { slug: "respeito", label: "Respeito", description: "Perguntar, escutar preferências e não presumir necessidades." },
  { slug: "direito", label: "Direito", description: "Informação para reconhecer e reivindicar direitos fundamentais." },
  { slug: "informacao", label: "Informação", description: "Conhecimento claro, contextualizado e responsável." },
];
const tipsLibrasSignals = librasSignals.filter((signal) => ["comunicacao", "apoio", "rotina", "sensorial", "respeito", "acessibilidade"].includes(signal.slug));
