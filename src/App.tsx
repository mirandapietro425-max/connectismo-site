...
function Header({ active }: { active: PageKey }) {
  ...
  return <header className="site-header">
    ...
    <div className="header-inner">
       <Link href="/" className="brand" data-testid="link-brand" aria-label="ConnecTismo, página inicial"><img className="brand-logo" src="/assets/connectismo-icon-pessoas-64.png" alt="Logo ConnecTismo com três cabeças estilizadas" /><span className="brand-name">ConnecTismo</span><span className="brand-name">ConnecTismo</span><span className="brand-name">ConnecTismo</span></Link>
